...
q1te = optic_fiber_channel.qzte

plt.figure(figsize=(20,10))
plt.title('Channel ISI simulation with equalization z=1 '+r'$t_0=$'+str(t0))
plt.plot(t,q0t,label="q(t,0)",color='blue',lw=3)
plt.plot(t,q1te,label='q(t,1)',color='red',lw=3)
plt.legend()
plt.savefig('../plots/ISI_simulation_with_equalization_q0t_q1te_t0='+str(t0)+'.png')